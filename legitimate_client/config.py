...
class OperatorSettings:
    ...
    fill_duration_range: tuple[int, int] = _range("FILL_DURATION_RANGE", (8, 15))
    drain_duration_range: tuple[int, int] = _range("DRAIN_DURATION_RANGE", (8, 15))
    phase_pause_range: tuple[int, int] = _range("PHASE_PAUSE_RANGE", (1, 3))
