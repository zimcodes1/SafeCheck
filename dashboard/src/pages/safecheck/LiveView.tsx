            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-xs text-amber-700/80 dark:text-amber-300/80 mt-0.5">
                  Backend could not reach the Modbus server at 127.0.0.1:5020. You can start the plant simulator with <code className="bg-amber-500/20 px-1.5 py-0.5 rounded font-mono">python plant/run.py</code>, or use the <strong>Simulate Attack</strong> panel above to exercise the detector.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-surface-1 rounded-2xl border border-border-subtle shadow-xs p-6 sm:p-8 transition-colors">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-xs text-text-secondary mt-0.5">Real-time physical state queried via Modbus input registers (0–2)</p>
            </div>
            {plantState && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            ...
            <div className="bg-surface-2 rounded-xl p-5 border border-border-subtle space-y-4 transition-colors">
              <div>
                <p className="text-xs font-medium text-text-tertiary uppercase tracking-wider">Water Level</p>
