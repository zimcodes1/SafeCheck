...
```
Attackers/Legit Client → Water Plant (Modbus TCP) → Backend (FastAPI + Detector) → Dashboard (React)
```
...
- **Background poller** for real-time monitoring
...
- `POST /commands/report` - Report commands
