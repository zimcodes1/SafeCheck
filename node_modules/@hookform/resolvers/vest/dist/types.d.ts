...
export type ICreateResult<TValues extends FieldValues = FieldValues, TContext = any> = Suite<any, any, (values: TValues, names?: FieldName<TValues>[], context?: TContext) => void>;
